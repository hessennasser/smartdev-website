		...
		const e = [
			{
				...
				answer:
					'أولاً/ اطلب الاشتراك <br> ثانياً؟ حمّل تطبيق LEO TV PLUS من خلال ابل ستور <br> ثالثاً: فعل الاشتراك <br> بعد الدخول على التطبيق ادخل اليوزر والباسورد الخاص باشتراكك <br> 
<a href="https://www.youtube.com/shorts/MLISDuF5SLs" > فيديو توضيحي </a>',
			},
			{
				question: 'ما هي طريقة تفعيل الاشتراك على اجهزة الاندرويد شاشات وجوالات وتابلت؟',
				answer:
					'أولاً: اطلب الاشتراك <br> ثانياً: حمّل تطبيق DOWNLOADER من متجر التطبيقات <br> ثالثاً:من داخل تطبيق Downloader قم بالبحث عن تطبيق باستخدام الرمز
( 622819 ) في خانة البحث <br> سيظهر لك تطبيق LEO TV قم بتحميله وفتحه <br> رابعاً: فعّل الاشتراك <br> قم بإدخال بيانات الدخول التي استلمتها في تطبيق LEO TV واضغط على تسجيل دخول <br>
<a href="https://www.youtube.com/shorts/vctRzqQKUwk" > فيديو توضيحي </a>',
			},
		];
		function n() {

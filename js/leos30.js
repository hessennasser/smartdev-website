		...
		const e = [
			{
				...
				answer:
					'نحن نقدم منتجات عالية <span>الجودة</span> من مصادر موثوقة مع ضمان الجودة والأصالة.',
			},
			{
				question: 'هل يوجد ضمان على الاشتراك؟',
				answer:
					'نعم، نوفر ضمان شامل على جميع اشتراكاتنا مع إمكانية الاستبدال أو الاسترداد.',
			},
			{
				question: 'اقدر اطلب من جهاز ثاني واعطيه بحسابي؟',
				answer:
					'يمكنك استخدام حسابك من أي جهاز، ولكن يجب مراعاة شروط الاستخدام المتعددة.',
			},
			{
				question: 'هل يتم تحديث التطبيقات بشكل مستمر؟',
				answer:
					'نعم، نقوم بتحديث التطبيقات بانتظام لضمان أفضل أداء وأحدث المميزات.',
			},
			{
				question: 'هل متجر leos30موثق؟',
				answer: 'متجرنا مرخص ومعتمد رسمياً مع سجل تجاري ساري المفعول.',
			},
			{
				question: 'كم مدة تسليم الطلب وكيف أستلم طلبي؟',
				answer:
					'مدة التسليم من 1-3 أيام عمل، ويتم التسليم عبر شركات الشحن المعتمدة.',
			},
			{
